...
rclpy.create_node('UserInterface')
#Node.__init__('user_interface')
location_publisher = UserInterface.create_publisher(Float32MultiArray, 'location', 10)
speed_publisher = UserInterface.create_publisher(Float32MultiArray, 'speed', 10)
