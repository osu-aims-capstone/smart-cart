...
class MinimalPublisher(Node):
    ...
    def __init__(self):
        ...
        self.publisher_ = self.create_publisher(Float32, 'motorRight', 10)
        ...
        #Subscriber for getting the current RPM from right encoder node
    ...
    def velocity_callback(self, msg):
        #self.get_logger().info('Publishing: "%d"' % msg.data[1]) 
        self.currentVel = msg.data[1]
